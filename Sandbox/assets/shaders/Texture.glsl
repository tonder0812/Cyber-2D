...
layout(location = 5) in float a_Channels;
layout(location = 6) in float a_ID;
...
void main()
{
	...
	switch (int(v_Channels)) {
		case 1:
			texColor = vec4(texColor.x, texColor.x, texColor.x, 1);
			break;
		case 2:
			texColor = vec4(texColor.x, texColor.x, texColor.x, texColor.y);
			break;
		case 3:
			texColor = vec4(texColor.x, texColor.y, texColor.z, 1);
			break;
		case 4:
			texColor = vec4(texColor.x, texColor.y, texColor.z, texColor.w);
			break;
	}
